...
import sys
from Generic2dimController import *
...
class Arpes2dimController(Generic2dimController):

	def __init__(self, cData,view=None, parent=None):
		if view == None:
			view = Ui_Generic2dimWindow()
		super(Arpes2dimController, self ).__init__(cData,view,parent)



	def configure_views(self):
		super(Arpes2dimController,self).configure_views()
