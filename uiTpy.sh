...
python /usr/local/bin/pyside-uic view/ui/Tools_ROIWidget2.ui > view/Tools_ROIWidget.py
...
python /usr/local/bin/pyside-uic view/ui/GenericPQGViewMW.ui > view/GenericPQGView.py
